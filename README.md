...
options:
  ...
  --no-heading-anchors  Omit the extra anchor from section headings. (default)
  --skip-invalid-url    Emit a warning but otherwise ignore relative URLs that point to an invalid location.
  --keep-invalid-url    Raise an error when relative URLs point to an invalid location. (default)
