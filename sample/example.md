...
Absolute link to an [external location](http://example.com/), relative link to a [heading in the same document](#Basic-features), or a relative link to another page synchronized by the tool.
